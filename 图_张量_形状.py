...
#
# plt = tf.placeholder(tf.float32, [None, 2, None])
#
# print(plt)
#
# plt.set_shape([3, 2, None])
#
# print(plt)
#
# plt.set_shape([3, 2, 4])
...
#
# # 面向过程：tf的内置函数/接口reshaoe
# plt_reshape = tf.reshape(plt, [4, 3, 2])  # 只要2*3*4不发生改变，在当前纬度上变更张量的形状都是允许的
#
# # 面向对象：plt对象的reshape方法
# # plt1 = plt.reshape([3, 3])
#
# print(plt_reshape)
#
